...
const ACTIVE_SKILL_STYLES: Record<string, { bg: string; border: string; color: string; xColor: string }> = {
  language: { bg: "rgba(79,70,229,0.1)", border: "rgba(99,102,241,0.3)", color: "#6d28d9", xColor: "#a78bfa" },
  framework_or_library: { bg: "rgba(59,130,246,0.1)", border: "rgba(59,130,246,0.3)", color: "#1d4ed8", xColor: "#60a5fa" },
  database: { bg: "rgba(16,185,129,0.1)", border: "rgba(16,185,129,0.3)", color: "#059669", xColor: "#34d399" },
  cloud: { bg: "rgba(245,158,11,0.1)", border: "rgba(245,158,11,0.3)", color: "#b45309", xColor: "#fbbf24" },
  tool: { bg: "rgba(236,72,153,0.1)", border: "rgba(236,72,153,0.3)", color: "#db2777", xColor: "#f472b6" },
  other: { bg: "rgba(107,114,128,0.1)", border: "rgba(107,114,128,0.3)", color: "#374151", xColor: "#9ca3af" },
};
...
export default function Skills() {
  const { allSkills, userSkills, fetchAllSkills, fetchUserSkills, addSkills, removeSkills } =
    useSkillsStore();
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 500,
                        color: isActive
                          ? CHECKED_COLOR[skill.type] || "#374151"
                          : "#3f3f46",
